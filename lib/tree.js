...
tree.prototype.getEachNodeMarkup = function (nodeObj, rootNode, selector) {
    ...
    if (nodeObj.children) {
        ...
        selectedNode.append($.parseHTML("<li name=" + nodeObj.label + " class='collapsed'>" + "<label>" + nodeObj.label + "</label>" + "<ul></ul></li>"));
        ...
        rootNode.find(selector).append($.parseHTML("<li name=" + nodeObj.label + ">" + "<label>" + nodeObj.label + "</label>" + "</li>"));
    }
};
